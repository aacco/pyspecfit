...
x = np.arange(800, 3000, 1) / 10
y_true = m(x=x, args=params)

thermal_noise = np.random.normal(0, 0.1, len(x))
...
df_xy.to_csv("./python/project/test/fit_test/sampledata/sampledata.csv")
plt.show()